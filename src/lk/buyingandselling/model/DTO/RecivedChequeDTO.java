...
public class RecivedChequeDTO {
    ...
    public RecivedChequeDTO() {
    }

    public RecivedChequeDTO(String recivedChaqueId, String bankName, String status, double amount, String realizationDate, String recivedDate) {
